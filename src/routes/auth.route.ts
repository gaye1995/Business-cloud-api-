...
route.post('/auth/create-bilan/actif', [authMiddleware], CloctureController.createBilanActif)
route.post('/auth/create-bilan/passif', [authMiddleware], CloctureController.createBilanPassif)
route.put('/auth/create-bilan/actif', [authMiddleware], CloctureController.updateActif)
